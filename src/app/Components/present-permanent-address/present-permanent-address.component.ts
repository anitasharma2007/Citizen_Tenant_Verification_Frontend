...
@Component({
  selector: 'app-present-permanent-address',
  templateUrl: './present-permanent-address.component.html',
  styleUrls: ['./present-permanent-address.component.css']
})
export class PresentPermanentAddressComponent implements OnInit {
